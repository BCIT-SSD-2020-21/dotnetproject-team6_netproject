    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemWishlistSnapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemWishlistSnapshots_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemWishlistSnapshots_ItemId",
                table: "ItemWishlistSnapshots",
                column: "ItemId");
        }
